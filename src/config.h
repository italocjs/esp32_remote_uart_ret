...
#define SSID     "Italo_mesh"      // SSID to join (or broadcast)
#define PASSWD   "39122820"  // wiFi password
#define HOSTNAME "esp32"     // hostname for STA mode mDNS

#define BUFFERSIZE 1024

#ifdef ESP32
#define VERSION "2.1-ESP32"
#elif defined(ESP8266)
#define VERSION "2.1-ESP8266"
#endif
...
#define SERIAL0_RXPIN 19          // receive Pin UART0 // moved to 19 to free up i2c
